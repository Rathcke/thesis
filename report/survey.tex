...
$(2^k-1)$. This is constructed in $O(kmn^{k/(2k-1)})$ time. \\
...
$O(\lg n)$ time. This was the first result to achieve logarithmic query time with
subquadratic space, as previous
...
seems the trade-off they give is hard to beat. We briefly outline the exact results,
which is the basis for a distance oracle in Section \ref{oracle3}.\\
\\
